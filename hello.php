    ...
    function hd_fs() {
        ...
        if ( ! isset( $hd_fs ) ) {
            ...
            $hd_fs = fs_dynamic_init( array(
                'id'                  => '5121',
                'slug'                => 'hello-dolly',
                'premium_slug'        => 'hello-dolly',
                'type'                => 'plugin',
                'public_key'          => 'pk_474d332b71e05940fcf3cad1f4d23',
                'is_premium'          => true,
                ...
                'secret_key'          => 'sk_=OSV^.-=ytoelrN^zA7+=oha*S?r^',
            ) );
        }
...
function hello_dolly_get_songs()
{
    ...
    if (hd_fs()->is_paying__fs__() ) {
        if (hd_fs()->is_plan('summertime')) {
            $songs[] = 'Summertime';
        }
        if (hd_fs()->is_plan('wonderful_world')) {
            $songs[] = 'Wonderful World';
        }
        if (hd_fs()->is_plan('dream')) {
